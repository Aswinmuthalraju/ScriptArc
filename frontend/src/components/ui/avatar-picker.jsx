...
export function AvatarPicker({ onSelect, defaultAvatarId }) {
    const defaultAvatar = avatars.find(a => a.id === defaultAvatarId) || avatars[0];
            ...
            <Card className="w-full max-w-md mx-auto overflow-hidden bg-gradient-to-b from-background to-muted/30">
                <CardContent className="p-0">
                    ...
                    <div className="px-8 pb-8 -mt-16">
                        <motion.div
                            className="relative w-40 h-40 mx-auto rounded-full overflow-hidden border-4 bg-background flex items-center justify-center cursor-pointer"
...
export const DemoAvatarPicker = () => {
    return <AvatarPicker onSelect={(id) => console.log("Selected:", id)} />;
}
